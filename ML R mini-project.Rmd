...
Normal_Check<- corcheck %>% dplyr::select(-status)
shapiro.test(Normal_Check$MDVP.Fo.Hz.)
shapiro.test(Normal_Check$MDVP.Fhi.Hz.)
shapiro.test(Normal_Check$Shimmer.APQ3)
shapiro.test(Normal_Check$Shimmer.DDA)
shapiro.test(Normal_Check$NHR)
shapiro.test(Normal_Check$HNR)
shapiro.test(Normal_Check$RPDE)
shapiro.test(Normal_Check$DFA)
shapiro.test(Normal_Check$spread1)
shapiro.test(Normal_Check$D2)
shapiro.test(Normal_Check$PPE)
```
